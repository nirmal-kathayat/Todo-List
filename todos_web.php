...
<body>
      ...
      <nav class="nav-todo">
            <div class="content">
                  <a class="navbar-todos" href="#">My Task Lists</a>
            ...
            <div class="container-icon">
                  <button type="button" class="btn btn-primary position-relative m-3">
                        ...
                        <?php
                        // db_conn.php contains the database connection code
                        // include('db_conn.php');

                        // Query to get the count of pending todos
      ...
      <div class="container">
            ...
            <h5 class="make-todo"> Manage Your Daily Routine. And <br>
                  <span>Keep Maintain.</span>
            </h5>
